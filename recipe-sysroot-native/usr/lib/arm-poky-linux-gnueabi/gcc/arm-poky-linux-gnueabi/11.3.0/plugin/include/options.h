...
enum opt_code
{
  ...
  /* OPT_Wbidi_chars = 468, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 469,                    /* -Wbidi-chars= */
  ...
  OPT_Wc__17_compat = 478,                   /* -Wc++17-compat */
  /* OPT_Wc__1z_compat = 479, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 480,                   /* -Wc++20-compat */
  /* OPT_Wc__2a_compat = 481, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 482,                 /* -Wc-binding-type */
  OPT_Wc11_c2x_compat = 483,                 /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 484,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 485,                 /* -Wc99-c11-compat */
  OPT_Wcannot_profile = 486,                 /* -Wcannot-profile */
  OPT_Wcast_align = 487,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 488,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 489,             /* -Wcast-function-type */
  OPT_Wcast_qual = 490,                      /* -Wcast-qual */
  OPT_Wcast_result = 491,                    /* -Wcast-result */
  /* OPT_Wcatch_value = 492, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 493,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 494,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 495,           /* -Wcharacter-truncation */
  OPT_Wchkp = 496,                           /* -Wchkp */
  OPT_Wclass_conversion = 497,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 498,                /* -Wclass-memaccess */
  OPT_Wclobbered = 499,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 500,                /* -Wcomma-subscript */
  OPT_Wcomment = 501,                        /* -Wcomment */
  /* OPT_Wcomments = 502, */                 /* -Wcomments */
  OPT_Wcompare_reals = 503,                  /* -Wcompare-reals */
  OPT_Wconditionally_supported = 504,        /* -Wconditionally-supported */
  OPT_Wconversion = 505,                     /* -Wconversion */
  OPT_Wconversion_extra = 506,               /* -Wconversion-extra */
  OPT_Wconversion_null = 507,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 508,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 509,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 510,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 511,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 512,                  /* -Wdangling-else */
  OPT_Wdate_time = 513,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 514,    /* -Wdeclaration-after-statement */
  OPT_Wdelete_incomplete = 515,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 516,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 517,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 518,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 519,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 520,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 521,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 522,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 523,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 524,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 525,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 526,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 527,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 528,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 529,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 530,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 531,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 532,                /* -Wduplicated-cond */
  OPT_Weffc__ = 533,                         /* -Weffc++ */
  OPT_Wempty_body = 534,                     /* -Wempty-body */
  OPT_Wendif_labels = 535,                   /* -Wendif-labels */
  OPT_Wenum_compare = 536,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 537,                /* -Wenum-conversion */
  OPT_Werror = 538,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 539, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 540,                         /* -Werror= */
  OPT_Wexceptions = 541,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 542,           /* -Wexpansion-to-defined */
  OPT_Wextra = 543,                          /* -Wextra */
  OPT_Wextra_semi = 544,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 545,                   /* -Wfatal-errors */
  OPT_Wfloat_conversion = 546,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 547,                    /* -Wfloat-equal */
  /* OPT_Wformat = 548, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 549,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 550,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 551,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 552,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 553, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 554,               /* -Wformat-overflow= */
  OPT_Wformat_security = 555,                /* -Wformat-security */
  OPT_Wformat_signedness = 556,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 557, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 558,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 559,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 560,             /* -Wformat-zero-length */
  OPT_Wformat_ = 561,                        /* -Wformat= */
  OPT_Wframe_address = 562,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 563,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 564,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 565,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 566,           /* -Wfunction-elimination */
  /* OPT_Whsa = 567, */                      /* -Whsa */
  OPT_Wif_not_aligned = 568,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 569,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 570,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 571,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 572, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 573,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 574,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 575,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 576,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 577,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 578, */                   /* -Wimport */
  OPT_Winaccessible_base = 579,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 580,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 581,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 582,             /* -Winit-list-lifetime */
  OPT_Winit_self = 583,                      /* -Winit-self */
  OPT_Winline = 584,                         /* -Winline */
  OPT_Wint_conversion = 585,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 586,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 587,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 588,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 589,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 590,                 /* -Wintrinsics-std */
  OPT_Winvalid_imported_macros = 591,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 592,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 593,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 594,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 595,               /* -Wjump-misses-init */
  OPT_Wl_ = 596,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 597, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 598,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 599,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 600,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 601,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 602,                     /* -Wlogical-op */
  OPT_Wlong_long = 603,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 604,              /* -Wlto-type-mismatch */
  OPT_Wmain = 605,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 606,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 607,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 608,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 609,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 610,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 611,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_tags = 612,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 613,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 614,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 615,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 616,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 617, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 618,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 619, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 620,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 621,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 622,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 623,                        /* -Wmudflap */
  OPT_Wmultichar = 624,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 625,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 626,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 627,                     /* -Wnamespaces */
  OPT_Wnarrowing = 628,                      /* -Wnarrowing */
  OPT_Wnested_externs = 629,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 630, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 631, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 632, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 633, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 634, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 635, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 636,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 637,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 638,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 639,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 640,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 641,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 642, */               /* -Wnormalized */
  OPT_Wnormalized_ = 643,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 644,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 645,                /* -Wobjc-root-class */
  OPT_Wodr = 646,                            /* -Wodr */
  OPT_Wold_style_cast = 647,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 648,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 649,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 650,                    /* -Wopenmp-simd */
  OPT_Woverflow = 651,                       /* -Woverflow */
  OPT_Woverlength_strings = 652,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 653,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 654,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 655,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 656,            /* -Woverwrite-recursive */
  OPT_Wp_ = 657,                             /* -Wp, */
  OPT_Wpacked = 658,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 659,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 660,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 661,                         /* -Wpadded */
  OPT_Wparentheses = 662,                    /* -Wparentheses */
  OPT_Wpedantic = 663,                       /* -Wpedantic */
  OPT_Wpessimizing_move = 664,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 665, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 666,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 667,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 668,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 669,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 670,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 671,            /* -Wpointer-to-int-cast */
  OPT_Wpoison_system_directories = 672,      /* -Wpoison-system-directories */
  ...
  OPT_fdiagnostics_escape_format_ = 1007,    /* -fdiagnostics-escape-format= */
  ...
  OPT_list = 1680,                           /* -list */
  OPT_mabi_ = 1681,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1682,             /* -mabort-on-noreturn */
  OPT_mandroid = 1683,                       /* -mandroid */
  OPT_mapcs = 1684,                          /* -mapcs */
  OPT_mapcs_frame = 1685,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1686,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1687,              /* -mapcs-stack-check */
  OPT_march_ = 1688,                         /* -march= */
  OPT_marm = 1689,                           /* -marm */
  OPT_masm_syntax_unified = 1690,            /* -masm-syntax-unified */
  OPT_mbe32 = 1691,                          /* -mbe32 */
  OPT_mbe8 = 1692,                           /* -mbe8 */
  OPT_mbig_endian = 1693,                    /* -mbig-endian */
  OPT_mbionic = 1694,                        /* -mbionic */
  OPT_mbranch_cost_ = 1695,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1696,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1697,     /* -mcaller-super-interworking */
  OPT_mcmse = 1698,                          /* -mcmse */
  OPT_mcpu_ = 1699,                          /* -mcpu= */
  OPT_mfdpic = 1700,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1701,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1702,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1703,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1704,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1705,                  /* -mfp16-format= */
  OPT_mfpu_ = 1706,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1707,             /* -mgeneral-regs-only */
  OPT_mglibc = 1708,                         /* -mglibc */
  /* OPT_mhard_float = 1709, */              /* -mhard-float */
  OPT_mlibarch_ = 1710,                      /* -mlibarch= */
  OPT_mlittle_endian = 1711,                 /* -mlittle-endian */
  OPT_mlong_calls = 1712,                    /* -mlong-calls */
  ...
  OPT_munaligned_access = 1734,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1735,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1736,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1737,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1738,              /* -mword-relocations */
  OPT_n = 1739,                              /* -n */
  ...
  OPT_time = 1864,                           /* -time */
  OPT_time_ = 1865,                          /* -time= */
  OPT_tno_android_cc = 1866,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1867,                 /* -tno-android-ld */
  OPT_traditional = 1868,                    /* -traditional */
  OPT_traditional_cpp = 1869,                /* -traditional-cpp */
  OPT_tree_stats = 1870,                     /* -tree-stats */
  OPT_trigraphs = 1871,                      /* -trigraphs */
  OPT_type_stats = 1872,                     /* -type-stats */
  OPT_u = 1873,                              /* -u */
  OPT_undef = 1874,                          /* -undef */
  OPT_v = 1875,                              /* -v */
  OPT_version = 1876,                        /* -version */
  OPT_w = 1877,                              /* -w */
  OPT_wrapper = 1878,                        /* -wrapper */
  OPT_x = 1879,                              /* -x */
  OPT_z = 1880,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
